    ...
    <div className="mb-4">
      <div className="relative">
        ...
        <input
          ...
          readOnly={isEditable} // Conditional readonly
          className={`w-full px-3 py-2 border border-kings-ransom rounded focus:outline-none ${
            isEditable ? "cursor-not-allowed" : "hover:border-kings-ransom"
          } bg-transparent text-sm font-normal`}
        />
        <button
          type="button"
          onClick={() => addField(field)}
          disabled={isEditable} // Disable button when isEditable is true
          className={`absolute right-3 top-[2.1rem] text-black-powder/70 ${
            isEditable
            ...
            isEditable
              ? "bg-gray-300"
              : "bg-kings-ransom/35 hover:bg-kings-ransom"
                        ...
                        >
                          <div className="flex items-center justify-center">
                            <div>
                              ...
                              <p className={isEditable ? "text-gray-400" : ""}>
                                {isEditable
                          ...
                          <input
                            ...
                            className="hidden"
                            multiple
                            disabled={isEditable} // Disable input when isEditable is true
                      ...
                      >
                        ...
                        <div className="absolute top-2 right-2">
                          <button
                            size="sm"
                            variant="outlined"
                            className={`flex items-center justify-center text-black-powder border-kings-ransom rounded ${
                              isEditable
                                ? "bg-gray-300 text-gray-500 cursor-not-allowed"
                                : "bg-kings-ransom/35 hover:bg-dark-olive-green hover:text-apple-cucumber duration-300 transition-all"
                            }`}
                            onClick={() => handleRemoveImage(index)}
                            disabled={isEditable} // Disable the button when isEditable is true
                          >
                            <X className="h-4 w-4" />
                          </button>
                        </div>
                  ...
                  <div className="w-full">
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        step="60"
                        onChange={(e) =>
                          handleOpeningHoursChange(e.target.value)
                        }
                      ...
                      <div className="relative ">
                        <select
                          ...
                          value={
                            formDetails?.opening_hours.split(" ")[1] || "AM"
                          }
                  ...
                  <div className="w-full">
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        step="60"
                        min={
                          formDetails?.opening_hours.split(" ")[0] || "00:00"
                        }
                        onChange={(e) =>
                          handleClosingHoursChange(e.target.value)
                        }
                      ...
                      <div className="relative ">
                        <select
                          ...
                          value={
                            formDetails?.closing_hours.split(" ")[1] || "AM"
                          }
                          className={`px-3 py-2 border border-kings-ransom rounded focus:outline-none bg-transparent text-sm font-normal text-[#33372C] appearance-none w-[4rem] ${
                            isEditable ? "cursor-not-allowed" : "cursor-pointer"
                          }`}
                        ...
                        {weeksData?.length > 0 ? (
                          weeksData.map((week, index) => (
                            <motion.li
                              ...
                              className={`px-6 py-2 ${
                                formDetails.working_days.includes(
                                  week.week_name
                                )
                                  ? "bg-apple-cucumber/70"
                                  : "bg-kings-ransom"
