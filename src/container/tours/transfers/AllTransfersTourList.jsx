...
import activitiesListIcon from "../../../assets/tour-transfers.png";
...
const AllTransfersTourList = ({ isOpen, onClose }) => {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          ...
          >
            <h2 className="text-lg font-semibold mb-4 text-black-powder">
              Delete This Tour Transfers
            </h2>
            <p className="text-sm font-medium text-black-powder">
              Are you sure you want to delete this tour transfers?
            </p>
...
export default AllTransfersTourList;
