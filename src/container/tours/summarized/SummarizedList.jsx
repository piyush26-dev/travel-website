...
import SummarizedListIcon from "../../../assets/summarized-view-icon.png";
...
const SummarizedList = ({ isOpen, onClose }) => {
  ...
  const currentData = SummarizedData.slice(
  ...
  const handleViewSummarized = () => {
    navigate("/view-summarized-tour");
  };
                ...
                <div className="flex items-center md:gap-8 gap-4 w-full">
                  <div className="flex items-center gap-2 text-black-powder">
                    <span className="text-sm font-medium">
                      Total Summarized Days
                    </span>
                    <span className="text-sm font-medium">:</span>
                    <span className="text-sm font-medium">
                      <CountUp end={data.totalSummarized} duration={5} />
                    </span>
                  </div>
                </div>
              </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          ...
          >
            <h2 className="text-lg font-semibold mb-4 text-black-powder">
              Delete This Tour Summarized
            </h2>
            <p className="text-sm font-medium text-black-powder">
              Are you sure you want to delete this tour summarized?
            </p>
